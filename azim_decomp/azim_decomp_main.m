...
%%
centerline_grid_time_series_dir = '/work/home/chandan/Chandan_case_files/SPOD_work_space/inner_cylinder_time_series';
...
grid_name= 'chamber';
count = 1;
sol_file_start_idx = 681;
number_of_files = 300; %112;
sol_file_end_idx = 1000; %sol_file_start_idx + number_of_files -1;
...
field_names = {'F11','F12','F13',...
               'F22','F23','F33',...
               'Q1','Q2','Q3'};
%  field_names = {'density','u_velocity','v_velocity','w_velocity','Temperature','pressure'};
