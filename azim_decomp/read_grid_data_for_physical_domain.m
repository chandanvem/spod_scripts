function dataset = read_grid_data_for_physical_domain(LES_data_file_name,phase_name,grid_name,field_name,src_blk)

axial_extent_nozzle_downstream = 565;
axial_extent_nozzle_sides = 26;
radial_extent = 184;
dataset_path = sprintf('/%s/%d/%s',grid_name,src_blk,field_name);
