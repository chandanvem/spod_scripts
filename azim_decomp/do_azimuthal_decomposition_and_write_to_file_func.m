function []  = do_azimuthal_decomposition_and_write_to_file_func(dataset,azi_mode_start,azi_mode_end,field_name,new_src_blk_id,h5OutName)


[N_axial,N_r,N_theta] = size(dataset);

nfft_theta = N_theta - 1;
dataset_fft = fft(dataset, N_theta, 3)/nfft_theta;
